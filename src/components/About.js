        ...
        <section className="page-section bg-primary text-white mb-0" id="about">
            <div className="container">
                ...
                <p className="lead l-2">I worked as a software engineer at an ODM. Our department was responsible for the BIOS development on laptops. 
                    ...
                    I have built several projects such as iOS application, android application, websites, and so on. <br /><br />
                    I'm fond of coding, and there is always a bunch of ideas running in my head. 
                    Solving problems makes me feel accomplished. Technologies and programming languages are changing from time to time, having the skill to learn fast is my asset. <br />
                    Would you like to build a creative software or application? Reach me out!</p>
                <div className="row">
